...
A simple **flashcard app** built with **Jetpack Compose**, **Room database**, and **MVVM architecture**. Add, view, edit and delete flashcards with a clean UI and persistent storage.
